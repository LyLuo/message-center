...
public class SocketClientInitializer extends ChannelInitializer<SocketChannel> {
	...
	public SocketClientInitializer(List<ConnectedListener> connectedListeners, List<DisconnectedListener> disconnectedListeners){
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("decoder", new SocketClientDecoder());
		pipeline.addLast("encoder", new SocketClientEncoder());
		pipeline.addLast("handler", new SocketClientHandler(connectedListeners,disconnectedListeners));
	}
}
